      ...
      {originalContent !== undefined ? (
        <>
          ...
          <div className="rounded-lg bg-slate-50 p-3 text-sm text-slate-600">
            <span className="mb-1 block text-xs font-medium uppercase tracking-wide text-[--color-muted]">
              What the AI said
            </span>
            {originalContent}
          </div>
        ...
        <label className="block">
          <span className="mb-1 block text-sm font-medium text-slate-900">
            What did the AI get wrong? <span className="text-[--color-muted]">(optional)</span>
          </span>
          <textarea
            name="original_content"
            rows={2}
            placeholder="e.g. It quoted $50 for a drain cleaning"
            className="w-full rounded-lg border border-[--color-border] px-3 py-2 text-sm text-slate-900"
          />
        </label>
      )}
